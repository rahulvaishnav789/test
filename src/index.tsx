...
import { ScrollingtextProps, Scrollingtext } from "./scrollingtext";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <scrollingtext message="world!"></scrollingtext>
   */
  return class ScrollingtextBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): ScrollingtextProps {
      const attrs = this.parseAttributes<ScrollingtextProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<Scrollingtext {...this.props} />, container);
    }
